 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilMapImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilMapImpl#getMapClass <em>Map Class</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilMapImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UtilMapImpl extends MapImpl implements UtilMap
{
  ...
  {
    return SpringDSLPackage.Literals.UTIL_MAP;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_MAP__NAME, oldName, name));
  }
  ...
  public void setMapClass(String newMapClass)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_MAP__MAP_CLASS, oldMapClass, mapClass));
  }
  ...
  public void setScope(String newScope)
  {
    ...
    scope = newScope;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_MAP__SCOPE, oldScope, scope));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.UTIL_MAP__NAME:
        return getName();
      case SpringDSLPackage.UTIL_MAP__MAP_CLASS:
        return getMapClass();
      case SpringDSLPackage.UTIL_MAP__SCOPE:
        return getScope();
    }
