 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopConfigImpl#getAopPointcuts <em>Aop Pointcuts</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopConfigImpl#getAopAdvisors <em>Aop Advisors</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopConfigImpl#getAspects <em>Aspects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AopConfigImpl extends AspectImpl implements AopConfig
{
  ...
  {
    return SpringDSLPackage.Literals.AOP_CONFIG;
  }
  ...
  public EList<AopPointcut> getAopPointcuts()
  {
    ...
    {
      aopPointcuts = new EObjectContainmentEList<AopPointcut>(AopPointcut.class, this, SpringDSLPackage.AOP_CONFIG__AOP_POINTCUTS);
    }
    return aopPointcuts;
  }
  ...
  public EList<AopAdvisor> getAopAdvisors()
  {
    if (aopAdvisors == null)
    {
      aopAdvisors = new EObjectContainmentEList<AopAdvisor>(AopAdvisor.class, this, SpringDSLPackage.AOP_CONFIG__AOP_ADVISORS);
    }
    return aopAdvisors;
  }
  ...
  public EList<AopAspect> getAspects()
  {
    if (aspects == null)
    {
      aspects = new EObjectContainmentEList<AopAspect>(AopAspect.class, this, SpringDSLPackage.AOP_CONFIG__ASPECTS);
    }
    return aspects;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.AOP_CONFIG__AOP_POINTCUTS:
        return ((InternalEList<?>)getAopPointcuts()).basicRemove(otherEnd, msgs);
      case SpringDSLPackage.AOP_CONFIG__AOP_ADVISORS:
        return ((InternalEList<?>)getAopAdvisors()).basicRemove(otherEnd, msgs);
      case SpringDSLPackage.AOP_CONFIG__ASPECTS:
