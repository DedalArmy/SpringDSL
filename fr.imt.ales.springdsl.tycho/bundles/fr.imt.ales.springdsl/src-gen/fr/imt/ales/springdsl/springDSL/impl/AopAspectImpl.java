 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getBackingBeanRef <em>Backing Bean Ref</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getAopPointcuts <em>Aop Pointcuts</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getDeclaredParents <em>Declared Parents</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopAspectImpl#getAdvises <em>Advises</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AopAspectImpl extends MinimalEObjectImpl.Container implements AopAspect
{
  ...
  {
    return SpringDSLPackage.Literals.AOP_ASPECT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.AOP_ASPECT__NAME, oldName, name));
  }
  ...
  public void setOrder(String newOrder)
  {
    ...
    order = newOrder;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.AOP_ASPECT__ORDER, oldOrder, order));
  }
  ...
  public Component getBackingBeanRef()
  {
    if (backingBeanRef != null && backingBeanRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpringDSLPackage.AOP_ASPECT__BACKING_BEAN_REF, oldBackingBeanRef, backingBeanRef));
      }
    }
  ...
  public void setBackingBeanRef(Component newBackingBeanRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.AOP_ASPECT__BACKING_BEAN_REF, oldBackingBeanRef, backingBeanRef));
  }
  ...
  public EList<AopPointcut> getAopPointcuts()
  {
    ...
    {
      aopPointcuts = new EObjectContainmentEList<AopPointcut>(AopPointcut.class, this, SpringDSLPackage.AOP_ASPECT__AOP_POINTCUTS);
    }
    return aopPointcuts;
  }
  ...
  public EList<DeclareParents> getDeclaredParents()
  {
    ...
    {
      declaredParents = new EObjectContainmentEList<DeclareParents>(DeclareParents.class, this, SpringDSLPackage.AOP_ASPECT__DECLARED_PARENTS);
    }
  ...
  public EList<Advise> getAdvises()
  {
    if (advises == null)
    {
      advises = new EObjectContainmentEList<Advise>(Advise.class, this, SpringDSLPackage.AOP_ASPECT__ADVISES);
    }
    return advises;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.AOP_ASPECT__AOP_POINTCUTS:
        return ((InternalEList<?>)getAopPointcuts()).basicRemove(otherEnd, msgs);
      case SpringDSLPackage.AOP_ASPECT__DECLARED_PARENTS:
        return ((InternalEList<?>)getDeclaredParents()).basicRemove(otherEnd, msgs);
      case SpringDSLPackage.AOP_ASPECT__ADVISES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.AOP_ASPECT__NAME:
        return getName();
      case SpringDSLPackage.AOP_ASPECT__ORDER:
        return getOrder();
      case SpringDSLPackage.AOP_ASPECT__BACKING_BEAN_REF:
