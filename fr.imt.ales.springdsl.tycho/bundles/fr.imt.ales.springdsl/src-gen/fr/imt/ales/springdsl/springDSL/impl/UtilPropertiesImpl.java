 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilPropertiesImpl#getPropertyfile <em>Propertyfile</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilPropertiesImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilPropertiesImpl#getIgnoreResourceNotFound <em>Ignore Resource Not Found</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilPropertiesImpl#getLocalOverride <em>Local Override</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilPropertiesImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UtilPropertiesImpl extends PropsImpl implements UtilProperties
{
  ...
  {
    return SpringDSLPackage.Literals.UTIL_PROPERTIES;
  }
  ...
  public NotificationChain basicSetPropertyfile(PropertyFile newPropertyfile, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__PROPERTYFILE, oldPropertyfile, newPropertyfile);
  ...
  public void setPropertyfile(PropertyFile newPropertyfile)
  {
    if (newPropertyfile != propertyfile)
    {
      ...
      if (propertyfile != null)
        msgs = ((InternalEObject)propertyfile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpringDSLPackage.UTIL_PROPERTIES__PROPERTYFILE, null, msgs);
      if (newPropertyfile != null)
        msgs = ((InternalEObject)newPropertyfile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpringDSLPackage.UTIL_PROPERTIES__PROPERTYFILE, null, msgs);
      msgs = basicSetPropertyfile(newPropertyfile, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__PROPERTYFILE, newPropertyfile, newPropertyfile));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__NAME, oldName, name));
  }
  ...
  public void setIgnoreResourceNotFound(sBoolean newIgnoreResourceNotFound)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__IGNORE_RESOURCE_NOT_FOUND, oldIgnoreResourceNotFound, ignoreResourceNotFound));
  }
  ...
  public void setLocalOverride(sBoolean newLocalOverride)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__LOCAL_OVERRIDE, oldLocalOverride, localOverride));
  }
  ...
  public void setScope(String newScope)
  {
    ...
    scope = newScope;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_PROPERTIES__SCOPE, oldScope, scope));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.UTIL_PROPERTIES__PROPERTYFILE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case SpringDSLPackage.UTIL_PROPERTIES__NAME:
        return getName();
      case SpringDSLPackage.UTIL_PROPERTIES__IGNORE_RESOURCE_NOT_FOUND:
        return getIgnoreResourceNotFound();
      case SpringDSLPackage.UTIL_PROPERTIES__LOCAL_OVERRIDE:
        return getLocalOverride();
      case SpringDSLPackage.UTIL_PROPERTIES__SCOPE:
        return getScope();
    }
