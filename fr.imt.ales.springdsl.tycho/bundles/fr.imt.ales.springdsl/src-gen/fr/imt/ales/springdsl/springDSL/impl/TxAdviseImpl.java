 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.TxAdviseImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.TxAdviseImpl#getTransactionManager <em>Transaction Manager</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.TxAdviseImpl#getTxAttribute <em>Tx Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TxAdviseImpl extends MinimalEObjectImpl.Container implements TxAdvise
{
  ...
  {
    return SpringDSLPackage.Literals.TX_ADVISE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.TX_ADVISE__NAME, oldName, name));
  }
  ...
  public void setTransactionManager(String newTransactionManager)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.TX_ADVISE__TRANSACTION_MANAGER, oldTransactionManager, transactionManager));
  }
  ...
  public NotificationChain basicSetTxAttribute(TxAttribute newTxAttribute, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SpringDSLPackage.TX_ADVISE__TX_ATTRIBUTE, oldTxAttribute, newTxAttribute);
  ...
  public void setTxAttribute(TxAttribute newTxAttribute)
  {
    if (newTxAttribute != txAttribute)
    {
      ...
      if (txAttribute != null)
        msgs = ((InternalEObject)txAttribute).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SpringDSLPackage.TX_ADVISE__TX_ATTRIBUTE, null, msgs);
      if (newTxAttribute != null)
        msgs = ((InternalEObject)newTxAttribute).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SpringDSLPackage.TX_ADVISE__TX_ATTRIBUTE, null, msgs);
      msgs = basicSetTxAttribute(newTxAttribute, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.TX_ADVISE__TX_ATTRIBUTE, newTxAttribute, newTxAttribute));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.TX_ADVISE__TX_ATTRIBUTE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.TX_ADVISE__NAME:
        return getName();
      case SpringDSLPackage.TX_ADVISE__TRANSACTION_MANAGER:
