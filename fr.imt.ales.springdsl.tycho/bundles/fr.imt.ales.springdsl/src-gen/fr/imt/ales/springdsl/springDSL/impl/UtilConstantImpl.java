 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilConstantImpl#getStaticField <em>Static Field</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilConstantImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UtilConstantImpl extends AttributeImpl implements UtilConstant
{
  ...
  {
    return SpringDSLPackage.Literals.UTIL_CONSTANT;
  }
  ...
  public void setStaticField(String newStaticField)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_CONSTANT__STATIC_FIELD, oldStaticField, staticField));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_CONSTANT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.UTIL_CONSTANT__STATIC_FIELD:
        return getStaticField();
      case SpringDSLPackage.UTIL_CONSTANT__NAME:
        return getName();
    }
