 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AdviseImpl#getPointcutRef <em>Pointcut Ref</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AdviseImpl#getPointcutExpression <em>Pointcut Expression</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AdviseImpl#getMethod <em>Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdviseImpl extends MinimalEObjectImpl.Container implements Advise
{
  ...
  {
    return SpringDSLPackage.Literals.ADVISE;
  }
    ...
    if (pointcutRef != null && pointcutRef.eIsProxy())
    {
      ...
      if (pointcutRef != oldPointcutRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpringDSLPackage.ADVISE__POINTCUT_REF, oldPointcutRef, pointcutRef));
      }
    }
    return pointcutRef;
  }
  ...
  public void setPointcutRef(AopPointcut newPointcutRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.ADVISE__POINTCUT_REF, oldPointcutRef, pointcutRef));
  }
  ...
  public void setPointcutExpression(String newPointcutExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.ADVISE__POINTCUT_EXPRESSION, oldPointcutExpression, pointcutExpression));
  }
  ...
  public void setMethod(String newMethod)
  {
    ...
    method = newMethod;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.ADVISE__METHOD, oldMethod, method));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.ADVISE__POINTCUT_REF:
        if (resolve) return getPointcutRef();
        return basicGetPointcutRef();
      case SpringDSLPackage.ADVISE__POINTCUT_EXPRESSION:
        return getPointcutExpression();
      case SpringDSLPackage.ADVISE__METHOD:
        return getMethod();
    }
