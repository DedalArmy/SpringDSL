 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.MapImpl#getKeyType <em>Key Type</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.MapImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapImpl extends CollectionImpl implements Map
{
  ...
  {
    return SpringDSLPackage.Literals.MAP;
  }
  ...
  public void setKeyType(String newKeyType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.MAP__KEY_TYPE, oldKeyType, keyType));
  }
  ...
  public EList<MapEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<MapEntry>(MapEntry.class, this, SpringDSLPackage.MAP__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.MAP__ENTRIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.MAP__KEY_TYPE:
        return getKeyType();
      case SpringDSLPackage.MAP__ENTRIES:
        return getEntries();
    }
