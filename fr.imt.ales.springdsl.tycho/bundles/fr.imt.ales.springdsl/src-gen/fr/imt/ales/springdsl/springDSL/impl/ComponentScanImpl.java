 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getBasePackage <em>Base Package</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getAnnotationConfig <em>Annotation Config</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getNameGeneratorBean <em>Name Generator Bean</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getResourcePattern <em>Resource Pattern</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getScopeResolver <em>Scope Resolver</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getScopedProxy <em>Scoped Proxy</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getUseDefaultFilters <em>Use Default Filters</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getIncludeFilters <em>Include Filters</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.ComponentScanImpl#getExcludeFilters <em>Exclude Filters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentScanImpl extends ContextImpl implements ComponentScan
{
  ...
  {
    return SpringDSLPackage.Literals.COMPONENT_SCAN;
  }
  ...
  public void setBasePackage(String newBasePackage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__BASE_PACKAGE, oldBasePackage, basePackage));
  }
  ...
  public void setAnnotationConfig(sBoolean newAnnotationConfig)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__ANNOTATION_CONFIG, oldAnnotationConfig, annotationConfig));
  }
  ...
  public Component getNameGeneratorBean()
  {
    if (nameGeneratorBean != null && nameGeneratorBean.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpringDSLPackage.COMPONENT_SCAN__NAME_GENERATOR_BEAN, oldNameGeneratorBean, nameGeneratorBean));
      }
    }
  ...
  public void setNameGeneratorBean(Component newNameGeneratorBean)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__NAME_GENERATOR_BEAN, oldNameGeneratorBean, nameGeneratorBean));
  }
  ...
  public void setResourcePattern(String newResourcePattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__RESOURCE_PATTERN, oldResourcePattern, resourcePattern));
  }
  ...
  public Component getScopeResolver()
  {
    if (scopeResolver != null && scopeResolver.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpringDSLPackage.COMPONENT_SCAN__SCOPE_RESOLVER, oldScopeResolver, scopeResolver));
      }
    }
  ...
  public void setScopeResolver(Component newScopeResolver)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__SCOPE_RESOLVER, oldScopeResolver, scopeResolver));
  }
  ...
  public void setScopedProxy(EnumScopedProxy newScopedProxy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__SCOPED_PROXY, oldScopedProxy, scopedProxy));
  }
  ...
  public void setUseDefaultFilters(sBoolean newUseDefaultFilters)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.COMPONENT_SCAN__USE_DEFAULT_FILTERS, oldUseDefaultFilters, useDefaultFilters));
  }
  ...
  public EList<IncludeFilter> getIncludeFilters()
  {
    ...
    {
      includeFilters = new EObjectContainmentEList<IncludeFilter>(IncludeFilter.class, this, SpringDSLPackage.COMPONENT_SCAN__INCLUDE_FILTERS);
    }
  ...
  public EList<ExcludeFilter> getExcludeFilters()
  {
    ...
    {
      excludeFilters = new EObjectContainmentEList<ExcludeFilter>(ExcludeFilter.class, this, SpringDSLPackage.COMPONENT_SCAN__EXCLUDE_FILTERS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpringDSLPackage.COMPONENT_SCAN__INCLUDE_FILTERS:
        return ((InternalEList<?>)getIncludeFilters()).basicRemove(otherEnd, msgs);
      case SpringDSLPackage.COMPONENT_SCAN__EXCLUDE_FILTERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.COMPONENT_SCAN__BASE_PACKAGE:
        return getBasePackage();
      case SpringDSLPackage.COMPONENT_SCAN__ANNOTATION_CONFIG:
        return getAnnotationConfig();
      case SpringDSLPackage.COMPONENT_SCAN__NAME_GENERATOR_BEAN:
        if (resolve) return getNameGeneratorBean();
        return basicGetNameGeneratorBean();
      case SpringDSLPackage.COMPONENT_SCAN__RESOURCE_PATTERN:
        return getResourcePattern();
      case SpringDSLPackage.COMPONENT_SCAN__SCOPE_RESOLVER:
        if (resolve) return getScopeResolver();
        return basicGetScopeResolver();
      case SpringDSLPackage.COMPONENT_SCAN__SCOPED_PROXY:
        return getScopedProxy();
      case SpringDSLPackage.COMPONENT_SCAN__USE_DEFAULT_FILTERS:
