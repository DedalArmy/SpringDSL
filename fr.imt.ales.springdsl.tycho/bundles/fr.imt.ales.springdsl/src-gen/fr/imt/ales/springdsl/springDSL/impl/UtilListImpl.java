 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilListImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilListImpl#getListClass <em>List Class</em>}</li>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.UtilListImpl#getScope <em>Scope</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UtilListImpl extends sListImpl implements UtilList
{
  ...
  {
    return SpringDSLPackage.Literals.UTIL_LIST;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_LIST__NAME, oldName, name));
  }
  ...
  public void setListClass(String newListClass)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_LIST__LIST_CLASS, oldListClass, listClass));
  }
  ...
  public void setScope(String newScope)
  {
    ...
    scope = newScope;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.UTIL_LIST__SCOPE, oldScope, scope));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.UTIL_LIST__NAME:
        return getName();
      case SpringDSLPackage.UTIL_LIST__LIST_CLASS:
        return getListClass();
      case SpringDSLPackage.UTIL_LIST__SCOPE:
        return getScope();
    }
