 ...
 * </p>
 * <ul>
 *   <li>{@link fr.imt.ales.springdsl.springDSL.impl.AopScopedProxyImpl#getProxyTargetClass <em>Proxy Target Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AopScopedProxyImpl extends MinimalEObjectImpl.Container implements AopScopedProxy
{
  ...
  {
    return SpringDSLPackage.Literals.AOP_SCOPED_PROXY;
  }
  ...
  public void setProxyTargetClass(String newProxyTargetClass)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SpringDSLPackage.AOP_SCOPED_PROXY__PROXY_TARGET_CLASS, oldProxyTargetClass, proxyTargetClass));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SpringDSLPackage.AOP_SCOPED_PROXY__PROXY_TARGET_CLASS:
