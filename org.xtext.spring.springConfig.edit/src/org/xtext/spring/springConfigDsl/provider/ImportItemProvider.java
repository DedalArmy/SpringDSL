...
/**
 * This is the item provider adapter for a {@link org.xtext.spring.springConfigDsl.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_resource_feature", "_UI_Import_type"),
				 SpringConfigDslPackage.Literals.IMPORT__RESOURCE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Import)object).getResource();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Import.class)) {
			case SpringConfigDslPackage.IMPORT__RESOURCE:
