...
/**
 * This is the item provider adapter for a {@link org.xtext.spring.springConfigDsl.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapItemProvider extends CollectionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Map_keyType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Map_keyType_feature", "_UI_Map_type"),
				 SpringConfigDslPackage.Literals.MAP__KEY_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringConfigDslPackage.Literals.MAP__ENTRIES);
		}
	...
	public String getText(Object object) {
		String label = ((Map)object).getValueType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringConfigDslPackage.Literals.MAP__ENTRIES,
				 SpringConfigDslFactory.eINSTANCE.createMapEntry()));
	}
