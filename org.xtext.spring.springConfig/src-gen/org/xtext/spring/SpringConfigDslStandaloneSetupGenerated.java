...
public class SpringConfigDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new SpringConfigDslRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/spring/SpringConfigDsl")) {
			EPackage.Registry.INSTANCE.put("http://www.xtext.org/spring/SpringConfigDsl", SpringConfigDslPackage.eINSTANCE);
		}
