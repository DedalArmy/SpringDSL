...
public interface Configuration extends EObject
{
  ...
  /**
	 * Returns the value of the '<em><b>Tx Jta Transaction Manager</b></em>' containment reference.
	 * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Tx Jta Transaction Manager</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
	 * @return the value of the '<em>Tx Jta Transaction Manager</em>' containment reference.
	 * @see #setTxJtaTransactionManager(TxJtaTransactionManager)
	 * @see org.xtext.spring.springConfigDsl.SpringConfigDslPackage#getConfiguration_TxJtaTransactionManager()
	 * @model containment="true"
	 * @generated
	 */
  TxJtaTransactionManager getTxJtaTransactionManager();

  /**
	 * Sets the value of the '{@link org.xtext.spring.springConfigDsl.Configuration#getTxJtaTransactionManager <em>Tx Jta Transaction Manager</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Tx Jta Transaction Manager</em>' containment reference.
	 * @see #getTxJtaTransactionManager()
	 * @generated
	 */
  void setTxJtaTransactionManager(TxJtaTransactionManager value);
